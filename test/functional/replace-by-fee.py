...
class ReplaceByFeeTest(CaliforniacoinTestFramework):
    ...
    def test_doublespend_chain(self):
        ...
        # child fees - 40 CALIFORNIACOIN - so this attempt is rejected.
        dbl_tx = CTransaction()
    ...
    def test_doublespend_tree(self):
        ...
        # 1 CALIFORNIACOIN fee is enough
        dbl_tx = CTransaction()
        dbl_tx.vin = [CTxIn(tx0_outpoint, nSequence=0)]
