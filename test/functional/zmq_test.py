...
class ZMQTest (CaliforniacoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that californiacoin has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("californiacoind has not been built with zmq enabled.")
