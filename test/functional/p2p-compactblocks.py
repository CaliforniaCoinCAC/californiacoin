...
# TestNode: A peer we use to send messages to californiacoind, and store responses.
...
class CompactBlocksTest(CaliforniacoinTestFramework):
    ...
    # This test actually causes californiacoind to (reasonably!) disconnect us, so do this last.
    ...
    # californiacoind's choice of nonce.
    ...
    # Test that californiacoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for californiacoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # californiacoind will not send blocktxn responses for blocks whose height is
