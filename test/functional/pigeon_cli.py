...
class TestCaliforniacoinCli(CaliforniacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from `californiacoin-cli -getinfo` and the RPCs data is retrieved from.")
