...
This document provides guidelines for internationalization of the Californiacoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `californiacoin_en.ts` remains unchanged.
