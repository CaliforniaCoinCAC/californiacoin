 ...
 * between californiacoind, and californiacoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("californiacoin-shutoff");
    ...
    FlushWallets();
#endif
    GenerateCaliforniacoins(false, 0, Params());
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/CaliforniacoinProject/Californiacoincoin>";
    const std::string URL_WEBSITE = "<https://californiacoincoin.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("californiacoin-loadblk");
...
/** Sanity checks
 *  Ensure that Californiacoin is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Californiacoin version %s\n", FormatFullVersion());
}
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Californiacoin process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    GenerateCaliforniacoins(fGenerate, gArgs.GetArg("-genproclimit", DEFAULT_GENERATE_THREADS), chainparams);
