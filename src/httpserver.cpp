...
{
    RenameThread("californiacoin-http");
...
{
    RenameThread("californiacoin-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/CaliforniacoinProject/Californiacoincoin/pull/6990)
