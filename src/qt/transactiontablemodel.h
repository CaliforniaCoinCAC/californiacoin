...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, CaliforniacoinUnits::SeparatorStyle separators=CaliforniacoinUnits::separatorStandard) const;
